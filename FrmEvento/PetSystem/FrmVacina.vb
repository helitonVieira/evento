...
Public Class FrmVacina
    ...
    Dim vacina, vacina2 As New ClVacina
    ...
    Public Sub salvaRegistro()
        Try
            ...
            vacina.nom_vacina = TxbDescricao.Text
            desc = TxbDescricao.Text
            ...
            If atualizar = 1 Then
                ...
                Try
                    ...
                    ultimo = vacina2.UltimoCadastrado
                ...
                atualizaDados()
            Else
                vacina.cod_vacina = TxbCodigo.Text
                vacina.Atualizar()
    ...
    Public Sub carregaFormulario()
        Try
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                atualizar = 2
                TxbCodigo.Text = ds.Tables(0).Rows(i)("cod_vacina").ToString
                TxbDescricao.Text = ds.Tables(0).Rows(i)("nom_vacina").ToString
