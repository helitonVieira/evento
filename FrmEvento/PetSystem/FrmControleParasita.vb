...
Public Class FrmControleParasita

    Dim conectar As New Controles.ConexaoSQL
    Dim ds, dsUltimo As New DataSet
    Dim controleParasita, controleParasita2 As New ClControleParasita
    ...
    Public Sub atualizaDados()
        ...
        ds = controleParasita.Consultar(cod, desc)
        tabela = ds.Tables(0)
    ...
    Public Sub salvaRegistro()
        Try
            ...
            controleParasita.nom_controle_parasita = TxbDescricao.Text
            desc = TxbDescricao.Text
            ...
            If atualizar = 1 Then
                ...
                Try
                    ...
                    ultimo = controleParasita2.UltimoCadastrado
                    Dim ult As String = ultimo.Tables(0).Rows(0)("ultimo")
                    controleParasita.cod_controle_parasita = Convert.ToInt16(ult) + 1

                    controleParasita.Cadastrar()
                    ultimo.Clear()
                Catch ex As Exception
                    controleParasita.cod_controle_parasita = 1
                End Try

                MsgBox(" cadastrado com sucesso", MsgBoxStyle.OkOnly, "Sucesso")
                atualizaDados()
            Else
                controleParasita.cod_controle_parasita = TxbCodigo.Text
                controleParasita.Atualizar()
    ...
    Public Sub carregaFormulario()
        Try
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                atualizar = 2
                TxbCodigo.Text = ds.Tables(0).Rows(i)("cod_controle_parasita").ToString
                TxbDescricao.Text = ds.Tables(0).Rows(i)("nom_controle_parasita").ToString
