...
Public Class FrmEspecie
    ...
    Dim especie, especie2 As New ClEspecie
    ...
    Public Sub salvaRegistro()
        Try
            ...
            especie.des_especie = TxbDescricao.Text
            desc = TxbDescricao.Text
            ...
            If atualizar = 1 Then
                ...
                Try
                    ...
                    ultimo = especie2.UltimoCadastrado
    ...
    Public Sub carregaFormulario()
        ...
        End Try
    End Sub
    Public Sub verificarAuteespecieo()
        If TxbCodigo.Text = "" Then
            Exit Sub
        End If
