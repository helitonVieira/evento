...
Public Class FrmPelagem

    Dim conectar As New Controles.ConexaoSQL
    Dim ds, dsUltimo As New DataSet
    Dim pelagem, pelagem2 As New ClPelagem
    ...
    Public Sub salvaRegistro()
        Try
            ...
            pelagem.des_pelagem = TxbDescricao.Text
            desc = TxbDescricao.Text
            ...
            If atualizar = 1 Then
                ...
                Try
                    ...
                    ultimo = pelagem2.UltimoCadastrado
    ...
    Public Sub carregaFormulario()
        Try
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                atualizar = 2
                TxbCodigo.Text = ds.Tables(0).Rows(i)("cod_pelagem").ToString
                TxbDescricao.Text = ds.Tables(0).Rows(i)("des_pelagem").ToString
