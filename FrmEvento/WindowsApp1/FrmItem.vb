...
Public Class FrmItem
    ...
    Public Sub salvaRegistro()
        Try
            ...
            If atualizar = 1 Then
                ...
                Catch ex As Exception
                    MsgBox(" Erro ao cadastrado", MsgBoxStyle.Critical, "Erro")
                    Exit Sub
                End Try
    ...
    Private Sub Dgv_Click(sender As Object, e As EventArgs) Handles Dgv.DoubleClick
        Try
            ...
            TxbDesMarca.Text = Dgv.CurrentRow.Cells(12).Value.ToString
    ...
    Private Sub BtnPesquisaFornecedor_Click(sender As Object, e As EventArgs) Handles BtnPesquisaFornecedor.Click
        frmPesquisa.tabela = "tab_fornecedor_item"
        frmPesquisa.ShowDialog()
    End Sub
    ...
    Private Sub BtnPesquisaUnidadeBarra_Click(sender As Object, e As EventArgs) Handles BtnPesquisaUnidadeBarra.Click
        frmPesquisa.tabela = "tab_unidade_item_barra"
        frmPesquisa.ShowDialog()
    End Sub
