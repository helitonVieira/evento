Public Class FrmPDV2
    ...
    Private Sub DgvItemVenda_CellClick(sender As Object, e As DataGridViewCellEventArgs)
        Try
    ...
    Private Sub btItemVenda_Click(sender As Object, e As EventArgs) Handles btItemVenda.Click
        TabControl1.SelectedIndex = 0
        TxbCodItem.Select()
    End Sub
    ...
    Private Sub TxbValorPagto_TextChanged(sender As Object, e As EventArgs) Handles TxbValorPagto.TextChanged
    ...
    Private Sub TxbNomPessoa_TextChanged(sender As Object, e As EventArgs)
        buscaPessoa(TxbBuscaNomPessoa.Text)
    End Sub
