Public Class ClIngressoImpresso
    ...
    Public Sub InserirIngressoImpresso()
        sql = "Insert Into tab_ingresso_impresso( cod_evento, seq_ingresso, qtd_impressa, val_total_impresso) Values ('" & cod_evento & "' ,'" & seq_ingresso & "' ,'" & qtd_impressa & "' , '" & val_total_impresso & "')"
        con.Operar(sql)
    End Sub
