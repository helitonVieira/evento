Public Class ClItem
    ...
    Public Sub Atualizar()
        sql = "Update tab_item Set des_item = '" & des_item & "' , 
                                ...
                                ind_tipo = '" & ind_tipo & "',
                                qtd_estoque_minimo = '" & Replace(qtd_estoque_minimo, ",", ".") & "',
                                qtd_estoque_maximo = '" & Replace(qtd_estoque_maximo, ",", ".") & "',
                                cod_marca = " & cod_marca & ",
                                ind_ativo = '" & ind_ativo & "' 
    ...
    Public Function UltimoCadastrado()
        sql = "Select coalesce(cast( max(cod_item) as varchar(5)),0)as ultimo From tab_item"
