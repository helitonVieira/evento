Public Class ClDespesa
    ...
    Public Sub Atualizar()
        sql = "Update tab_despesa Set cod_empresa = " & cod_empresa & ",
                      ...
                      cod_recebimento_especie = " & cod_recebimento_especie & ",
                      val_recebimento_especie = " & Replace(Replace(val_recebimento_especie.ToString, ".", ""), ",", ".") & ","
    ...
    Public Function UltimoCadastrado()
        sql = "Select coalesce(cast( max(seq_despesa) as varchar(5)),0)as ultimo From tab_despesa"
