Public Class ClVenda
    ...
    Public Sub InserirVenda()
        sql = "Insert Into tab_venda(cod_evento,cod_item,qtd_item,val_total_item,val_total_custo_item,ind_tipo ) Values ('" & cod_evento & "' , '" & cod_item & "','" & qtd_item & "','" & val_total_item & "','" & val_total_custo_item & "','" & ind_tipo & "')"
        con.Operar(sql)
    End Sub
