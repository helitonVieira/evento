...
Public Class FrmTipoParcelamento
    ...
    Public Sub salvaRegistro()
        Try
            ...
            tipoParcelamento.des_tipo = TxbDescricao.Text
            desc = TxbDescricao.Text
            ...
            If atualizar = 1 Then
                ...
                Try
                    ...
                    tipoParcelamento.cod_tipo = Convert.ToInt16(ult) + 1

                    tipoParcelamento.Cadastrar()
                    ultimo.Clear()
                Catch ex As Exception
                    tipoParcelamento.cod_tipo = 1
                End Try

                MsgBox(" cadastrado com sucesso", MsgBoxStyle.OkOnly, "Sucesso")
                atualizaDados()
            Else
                tipoParcelamento.cod_tipo = TxbCodigo.Text
    ...
    Public Sub carregaFormulario()
        Try
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                atualizar = 2
                TxbCodigo.Text = ds.Tables(0).Rows(i)("cod_tipo").ToString
                TxbDescricao.Text = ds.Tables(0).Rows(i)("des_tipo").ToString
