...
Public Class FrmBanco
    ...
    Dim banco, banco2 As New ClBanco
    ...
    Public Sub salvaRegistro()
        Try
            ...
            banco.nom_banco = TxbDescricao.Text
            desc = TxbDescricao.Text
            ...
            If atualizar = 1 Then
                ...
                Try
                    ...
                    banco.cod_banco = Convert.ToInt16(ult) + 1
                ...
                atualizaDados()
            Else
                banco.cod_banco = TxbCodigo.Text
                banco.Atualizar()
    ...
    Public Sub carregaFormulario()
        Try
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                atualizar = 2
                TxbCodigo.Text = ds.Tables(0).Rows(i)("cod_banco").ToString
                TxbDescricao.Text = ds.Tables(0).Rows(i)("nom_banco").ToString
