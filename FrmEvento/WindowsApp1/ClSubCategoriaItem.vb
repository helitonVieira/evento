Public Class ClSubCategoriaItem
    ...
    Public Function ConsultarCodigo()
        sql = "Select * From tab_subcategoria_item Where cod_subcategoria =" & cod_subcategoria & ""
        ds = con.Listar(sql)
        Return ds
    End Function
    ...
    Public Function UltimoCadastrado()
        sql = "Select coalesce(cast( max(cod_subcategoria) as varchar(5)),0)as ultimo From tab_subcategoria_item"
